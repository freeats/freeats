...
module ImapTestHelper
  ...
  PARSED_SIMPLE_MESSAGE = Imap::Message.new(
    ...
    headers: [
      ...
      { "ARC-Authentication-Results" => "i=2; mx.google.com;       dkim=pass header.i=@toughbyte.com header.s=google header.b=TzxdsK4Z;       spf=pass (google.com: domain of admin@mail.com designates 209.85.220.41 as permitted sender) smtp.mailfrom=admin@mail.com;       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=toughbyte.com" },
      ...
      { "ARC-Authentication-Results" => "i=1; mx.google.com;       dkim=pass header.i=@toughbyte.com header.s=google header.b=TzxdsK4Z;       spf=pass (google.com: domain of admin@mail.com designates 209.85.220.41 as permitted sender) smtp.mailfrom=admin@mail.com;       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=toughbyte.com" },
      ...
      { "X-Original-Authentication-Results" => "mx.google.com;       dkim=pass header.i=@toughbyte.com header.s=google header.b=TzxdsK4Z;       spf=pass (google.com: domain of admin@mail.com designates 209.85.220.41 as permitted sender) smtp.mailfrom=admin@mail.com;       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=toughbyte.com" },
      { "Precedence" => "list" },
