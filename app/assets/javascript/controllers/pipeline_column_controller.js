...
export default class extends Controller {
  ...
  loadMore() {
    ...
    if (scrollWindow.scrollHeight - scrollWindow.clientHeight - scrollWindow.scrollTop > threshold)
      return;
    ...
    switch (this.data.get('status')) {
      ...
      case 'processing':
        return;
      case 'failed':
        console.warn('pipeline-column#loadMore failed'); // eslint-disable-line no-console
        return;
      case 'probablyMore': {
